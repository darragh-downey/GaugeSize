...
/**
 * Converted by ddowney on 16/7/17. from Google Camera2 api example
 */
...
class Cam2BasicFragment : Fragment(), View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
     ...
     * Front facing camera
     */
    private var mFrontCamera: String = "0"

    /**
     * Rear facing camera
     */
    private var mRearCamera: String = "1"

    /**
     * ID of the current [CameraDevice].
     */
    private var mCameraId: String? = mRearCamera
    ...
    //private var switchCameraButton: View = view.findViewById(R.id.switch_camera)

    fun switch() {
        if(mCameraId.equals(mFrontCamera)) {
            mCameraId = mRearCamera
            closeCamera()
            reopenCamera()
            //switchCameraButton.SetImageResource(R.drawable.ic_switch_camera)
        } else if(mCameraId.equals(mRearCamera)) {
            mCameraId = mFrontCamera
            closeCamera()
            reopenCamera()
            //switchCameraButton.SetImageResource(R.drawable.ic_switch_camera)
        }
    ...
    companion object {
        ...
        fun newInstance(): Cam2BasicFragment {
            return Cam2BasicFragment()
        }
    }

    external fun processImage(width: Int, height: Int, frameData: Array<Byte>, pixels: Array<Int>)
